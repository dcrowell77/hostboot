/*
 Create a new function that will return a vector of all Target instances that match the following criteria:
 - ATTR_TYPE = TYPE_PROC_CHIP
 - ATTR_PROC_FABRIC_GROUP_ID = input value
